...
class SportsbetResolver:
    name = "sportsbet"
    start_url = f"{BASE}/betting/australian-rules/afl"
    ...
    async def resolve(cls, game, alias_map, ctx):
        ...
        try:
            ...
            # Sportsbet often lists all upcoming matches; filter anchors with both teams present
            ...
            for a in anchors:
                ...
                if not href or "/afl/" not in href: 
                    continue
                # Require both teams present in text
                score = 0
