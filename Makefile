...
.PHONY: bronze-discover bronze-fixtures bronze-odds-live bronze-odds-hist bronze-weather-forecast bronze-weather-history qa-bronze qa-silver silver gold pipeline-run
...
# Silver and Gold runners
silver:
	$(PYTHON) scripts/silver/build_silver.py --season 2025

gold:
	$(PYTHON) scripts/gold/build_gold.py --season 2025
